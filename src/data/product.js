let detalleProductos = [
    {
        ...
        resumen: "Masaje Cuello, hombros y espalda, Tratamiento facial Piel Sensible y Tratamiento corporal de Drenaje Linfático.",
        precio: "Precio : $2.800,-",
        duration: 120,
    ...
    },
    {
        ...
        resumen: "Masaje Cuello, hombros y cabeza, Masaje de Aromaterapia y Tratamiento corporal de Maderoterapia.",
        precio: "Precio : $2.800,-",
        duration: 120,
    ...
    },
    {
        ...
        resumen: "Masaje de Piedras Calientes, Tratamiento facial Anti Age, Tratamiento corporal de Drenaje Linfático.",
        precio: "Precio : $3.000,-",
        duration: 120,
    ...
    },
    {
        ...
        resumen: "Aromaterapia con aceites vegetales altamente concentrados, llamados aceites esenciales, agregados al aceite o loción de masaje.",
        precio: "Precio : $2.000,-",
        duration: 60,
    ...
    },
    {
        ...
        resumen: "Las piedras calientes se colocan en puntos específicos para trabajar el músculo.",
        precio: "Precio $2.000,-",
        duration: 60,
    ...
    },
    {
        ...
        resumen: "Masaje enfocándose en el cuello, los hombros y el cuero cabelludo para aliviar la tensión.",
        precio: "Precio: $1.600,-",
        duration: 30,
    ...
    },
    {
        ...
        resumen: "Masajear estos puntos de presión ayuda a reducir el estrés y las migrañas.",
        precio: "Precio : $ 1.800,-",
        duration: 60,
    ...
    },
    {
        ...
        resumen: "Sistema de oxigenoterapia diseñado para tratar problemas de piel grasa o acné.",
        precio: "Precio : $1.000,-",
        duration: 40,
    ...
    },
    {
        ...
        resumen: "Un tratamiento facial personalizado con vitamina C que repara y previene el envejecimiento y daños en la piel.",
        precio: "Precio : $1.000,-",
        duration: 40,
    ...
    },
    {
        ...
        resumen: "Limpia, tonifica, tratamiento con enzimas naturales totalmente especiales.",
        precio: "Precio : $1.000,-",
        duration: 40,
    ...
    },
    {
        ...
        resumen: "Un tratamiento de espalda personalizado y efectivo para aquellos que son propensos al acné y problemas de la piel.",
        precio: "Precio : $1.200,-",
        duration: 40,
    ...
    },
    {
        ...
        resumen: "Delicado y placentero, con grandes beneficios.",
        precio: "Precio : $1.600,-",
        duration: 60,
    ...
    },
    {
        ...
        resumen: "Es un tratamiento que se basa en un masaje realizado a través del uso de instrumentos de madera de diferentes formas, tamaños y diseños.",
        precio: "Precio : $1.200,-",
        duration: 60,
    ...
    },
    {
        ...
        resumen: "Manicure + Color + Humectación + Fortalecedor",
        precio: "Precio : $500,-",
        duration: 40,
    ...
    },
    {
        ...
        resumen: "Manicure + Color + Humectación + Fortalecedor + Baño de Parafina",
        precio: "Precio : $700,-",
        duration: 40,
    ...
    },
    {
        ...
        resumen: "Pedicure + Hidromasaje + Color",
        precio: "Precio : $700,-",
        duration: 40,
